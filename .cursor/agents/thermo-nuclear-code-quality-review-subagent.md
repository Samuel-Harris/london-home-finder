...
description: Thermo-nuclear code quality audit (maintainability, structure, 1k-line rule, spaghetti, code-judo). Invoked via Task after a parent gathers diff and file contents. Loads rubric from the `thermo-nuclear-code-quality-review` skill.
---
...
Invoked by `thermos` after it has gathered the packet. Do not re-gather. Do not invoke this agent as the review parent.
